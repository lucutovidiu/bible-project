...
import {BibleVerseStored, createInitialState, SelectedBibleBook, SiteState} from "./site-state";
...
@StoreConfig({
  name: 'site-store',
  resettable: true,
  cache: { ttl: 24 * 60 * 60 * 1000 }, // TTL (time-to-live) to one day (i.e., 24 hours), you can specify a value of 86400000 milliseconds (24 hours x 60 minutes x 60 seconds x 1000 milliseconds)
})
